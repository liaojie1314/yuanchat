...
> 又追加完成了 A6 / A7 / A8 / H1 / H1b / admin-hardening / K6 / K7 / K8 与
> 「对象级读授权 + 离线对象 GC」。
>
...
> **待排**：K 泳道剩余项（K1 消息编辑、K3 命令面板、K12 桌面托盘、K17 新设备登录通知…）、
...
| 待排       | K 泳道剩余项        | K1 / K3 / K12 / K17 等     | 视挑选   | 见 MASTER_PLAN K 泳道表   |
...
| 其余 | K1-K5 / K9-K17    | 候选      | 优先级与依赖见 MASTER_PLAN K 泳道表                |
...
```
A8 B6 B7 B8 H1b K6 K7 K8      ✅ 已完成（保留于图中以示依赖已解除）
...
K1                            需扩 golden 契约（message.edited 帧）
