          ...
          <div>
            <div className="flex gap-3">
              ...
              <button
                ...
                className="group relative shrink-0 overflow-hidden rounded-xl border border-outline-variant bg-surface-container-low"
                title="点击刷新验证码"
              >
                <span
                  className="block h-12 min-w-[120px]"
                  dangerouslySetInnerHTML={{
                    __html:
                      captchaImg ||
                      '<span class="flex h-full items-center justify-center px-4 text-label-sm text-on-surface-variant">点击获取</span>',
                  }}
                />
            ...
            {!error && (
              <p className="text-on-surface-variant mt-1.5 text-label-sm">点击图片可刷新验证码</p>
            )}
          </div>
