-- 001_baseline.sql — 元聊 YuanChat 基准 Schema 快照
-- 包含 001_init.sql 与 002_contacts.sql 全部表结构。
-- 所有语句使用 IF NOT EXISTS / IF EXISTS 保证幂等，可安全重跑。
